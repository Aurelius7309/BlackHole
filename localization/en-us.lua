return {
    misc = {
        v_dictionary = {
            tts_welcome = [[Welcome to Balatro #1#! Using Black Hole version #2#, Steamodded version #3#. Press Y to start the game. Press 1 to read this message again. Press 2 to change the game speed. Press 3 to setup the keyboard controller. Press 0 to toggle additional sounds. If you are playing on a Mac, press 7 and 8 to adjust the speech rate.]],
            ...
            tts_ante = [[Ante #1# ]],
            tts_challenge_locked = [[Challenge mode is locked. Win a run with at least #1# different decks to unlock it (currently #2#). ]],
        },
        dictionary = {
            tts_time = 'time',
            tts_times = 'times',
            ...
            tts_rate_unsupported = [[This command is not supported on Windows. Adjust the speech rate in your screen reader or the Windows control panel. ]],
            tts_skip_blind = "Skip Blind for - ",
            tts_tutorial = [[Press X to start the tutorial. Press A to start a new run. ]],
            tts_select_run_choice = [[Press A to start a new run. Press B to continue your run. Press Y to start a challenge. Press Start to cancel. ]],
            tts_continuing_run = [[Continuing your run. ]],
            tts_starting_run = [[Starting your run. ]],
            tts_starting_chal = [[Starting your challenge. ]],
            ...
            tts_init_chal_select = [[Use the D-Pad Left and Right buttons to select a challenge. Press A to start the challenge once you are ready. Press Start to cancel. ]],
            tts_locked_deck = [[This deck is locked. To play it, first fulfill its unlock condition. ]],
            tts_new_run = [[Press Y to start a new run. ]],
            tts_additional_sounds_on = [[Additional sounds are enabled. Press 0 to disable them. ]],
            tts_additional_sounds_off= [[Additional sounds are disabled. Press 0 to enable them.]],
        },
        tts_keybinds = {
            dpleft = 'D-Pad left',
            dpright = 'D-Pad right',
