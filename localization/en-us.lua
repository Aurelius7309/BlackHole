return {
    misc = {
        ...
        dictionary = {
            ...
            tts_init_deck_select = [[Use the D-Pad Left and Right buttons to select a deck. Use the shoulder buttons to select a stake. Press A to start your run once you are ready. ]],
